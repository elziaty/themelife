                ...
                <form action="{{route('address-update')}}" method="post">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" id="l-name" class="form-control address-phone-with-country-picker" value="{{ $shippingAddress['phone'] }}" placeholder="{{translate('ex')}} : {{translate('01XXXXXX')}}" required>
                            <input type="hidden" name="phone" class="address-phone-with-country-hidden" value="{{ $shippingAddress['phone'] }}">
                        </div>
                        <div class="col-sm-6">
