                    ...
                    <form  action="{{route('address-store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="tel" id="phone" class="form-control address-phone-with-country-picker" placeholder="{{translate('ex')}} : {{translate('01XXXXXX')}}" required>
                                <input type="hidden" name="phone" class="address-phone-with-country-hidden">
                            </div>
                            <div class="col-sm-6">
