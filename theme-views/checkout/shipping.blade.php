                    ...
                    <form method="post" id="address-form">
                        <div class="delivery-information mt-32px">
                            <div class="d-flex flex-wrap row-gap-3 column-gap-4 mb-20px align-items-end">
                                <div class="font-bold letter-spacing-0 title m-0 text-capitalize">{{translate('Shipping_Address')}}</div>
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer p-3">
                                                <button type="button" class="btn rounded btn-base secondary-color" data-bs-dismiss="modal">{{translate('close')}}</button>
                ...
                @if($billing_input_by_customer)
                    <div class="delivery-information mt-32px {{ $billing_input_by_customer ? '':'d-none' }}">
                        ...
                        <div class="col-md-12 g-4">
                            <div class="--bg-4 rounded p-3 d-flex flex-wrap row-gap-2 column-gap-3 align-items-center justify-content-between">
                                <div class="font-bold letter-spacing-0 title m-0 text-capitalize">{{translate('billing_address')}}</div>

                                @if($physical_product_view)
                                <label class="form-check flow-reverse m-0 ms-auto">
                                    <span class="form-check-label text-capitalize">{{translate('same_as_delivery_address')}}</span>
                                    <input type="checkbox" name="same_as_shipping_address" id="same_as_shipping_address" class="form-check-input  dark-form-check-input" {{$billing_input_by_customer==1?'':'checked'}}>
                                </label>
                                @endif
                            </div>
                        </div>
                            ...
                            <form method="post" id="billing-address-form">
                                <div class="delivery-information mt-32px" id="hide_billing_address">
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="tel" placeholder="{{translate('phone')}}" id="billing_phone" class="form-control phone-input-with-country-picker-billing" {{$shipping_addresses->count()==0?'required':''}}>
                                            <input type="hidden" class="country-picker-phone-number-billing w-50" name="billing_phone" id="billing_phone_hidden" readonly>
                                        </div>
                                        @if(!auth('customer')->check())
                                            <div class="col-sm-6">
