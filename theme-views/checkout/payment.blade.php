                    ...
                    <div class="delivery-information">
                        ...
                        <div class="payment-area">
                            ...
                            @if(auth('customer')->check() && $wallet_status==1)
                                <label class="payment-item">
                                    <div class="payment-item-card">
                                        <img loading="lazy" src="{{theme_asset('assets/img/checkout/digital-wallet.png')}}" class="icon"
                                             alt="{{ translate('checkout') }}">
                                        <button class="content bg-white border-0"
                                                        ...
                                                        <div class="col-xl-3 col-md-4 col-6">
                                                            <div
                                                                ...
                                                                <form method="post"
                                                                    ...
                                                                    <button class="bg-transparent border-0 h-100 w-100 px-2"
                                                                            type="submit">
                                                                        <img loading="lazy" width="100" class="dark-support mw-100" alt="{{ translate('gateway') }}"
                                                        ...
                                                        <div class="col-xl-3 col-md-4 col-6">
                                                            <form
                                                                ...
                                                                <div class="digital-payment-card card">
                                                                    ...
                                                                    <span class="bg-transparent border-0 h-100 w-100 px-2"
                                                                    ...
                                                                    <img loading="lazy" width="100"
                                                                         ...
                                                                         class="dark-support mw-100" alt="{{ translate('offline_payments') }}">
                                                                </span>
                                                                </div>
                                                            </form>
                                                        </div>
