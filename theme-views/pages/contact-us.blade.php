                        ...
                        <div class="col-lg-8 order-1">
                            <form action="{{route('contact.store')}}" method="POST" id="getResponse">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6 form-group mb-4">
                                        <input type="text" value="{{ old('mobile_number') }}" class="form-control phone-input-with-country-picker" placeholder="{{ translate('contact_number') }}">
                                        <input type="hidden" name="mobile_number" value="{{ old('mobile_number') }}" class="country-picker-phone-number">
                                    </div>
                                    <div class="col-sm-12 col-md-6 form-group mb-4">
