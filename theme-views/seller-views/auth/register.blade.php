    ...
    <script>
        ...
        @if($web_config['recaptcha']['status'] == '1')
            var onloadCallback = function () {
                let reg_id = grecaptcha.render('recaptcha-element-vendor-regi', {'sitekey': '{{ $web_config['recaptcha']['site_key'] }}'});
        ...
        @else
            $('#recaptcha-vendor-regi').on('click', function(){
                ...
                genUrl = genUrl.replace(":dummy-id", Math.random()) + '?captcha_session_id=sellerRecaptchaSessionKey';
