                        ...
                        <div class="others-store-card text-capitalize">
                            <div class="name-area">
                                <div class="position-relative rounded-circle overflow-hidden">
                                    <div>
                                        <img loading="lazy" src="{{ getStorageImages(path: $shop->image_full_url, type: 'shop') }}"
                                    ...
                                    @elseif(($shop->vacation_status && ($current_date >= $shop->vacation_start_date) && ($current_date <= $shop->vacation_end_date)))
                                        <span class="temporary-closed position-absolute text-center h6 rounded-full">
                                ...
                                <div class="info">
                                    ...
                                    <span
                                        class="offer-badge">{{ round($shop['positive_review']) }}% {{ translate('positive_review') }}</span>
                                </div>
                            </div>
                            <div class="info-area">
                                <div class="info-item">
                                    <h6>{{ $shop['review_count']}}</h6>
                                    <span>{{ translate('reviews') }}</span>
                                </div>
                                <div class="info-item">
                                    <h6>{{ $shop['products_count'] < 1000 ? $shop['products_count'] : number_format($shop['products_count']/1000 , 1).'K'}}</h6>
