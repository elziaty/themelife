                        ...
                        <div class="footer-address">
                            ...
                            <div class="footer-address-card d-flex gap-3">
                                ...
                                <div>
                                    ...
                                    <div><a href="tel:{{$web_config['phone']->value}}" class="text-dark direction-ltr">{{$web_config['phone']->value}}</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="footer-bottom-wrapper text-capitalize">
                                ...
                                <div class="footer-widget ">
                                    ...
                                    <ul class="links">
                                        ...
                                        <li>
                                            <a href="{{route('vendor.auth.registration.index')}}">{{ translate('sell_on') }} {{ $web_config['name']->value }}</a>
                                        </li>
                                        @endif
