...
<div class="product-card product-card-row product-cart-option-container">
    ...
    <div class="product-card-inner d-">
        ...
        <div class="cont">
            ...
            <div class="d-flex flex-wrap gap-2">
                ...
                @else
                    <form class="cart d-none addToCartDynamicForm" action="{{ route('cart.add') }}" data-id="add-to-cart-form-{{$product['id']}}"
                    ...
                    <a href="javascript:" data-form-id="{{ 'add-to-cart-form-'.$product['id'] }}"
                       class="btn btn-base flex-grow-1 justify-content-center __btn-outline add_to_cart_button">
                        <i class="bi bi-cart"></i>
                        {{translate('add_to_cart')}}
                    </a>
                @endif
                ...
                <a href="javascript:"
                   ...
                   data-id="{{$product['id']}}"><i
                        class="bi bi-shuffle compare_list_icon-{{$product['id']}} {{($compareList == 1?'text-base':'')}}"></i></a>
            </div>
        </div>
    </div>
</div>
