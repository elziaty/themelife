...
function getStockCheckForProduct(productID, productCartForm) {
    ...
    if (minValue >= valueCurrent) {
        $('.product_quantity__qty' + productID).val(minValue);
    }
...
$('.stock_check_for_product_web').on('change', function () {
    ...
    getStockCheckForProduct(productID, productCartForm);
})
