    ...
    $(document).ready(function () {
        ...
        $(".search-toggle").on("click", function () {
            if ($(".mobile-search-form-wrapper").hasClass("open")) {
                ...
                $(".search-form").find("input.form-control").focus();
            }
        });
        /*==================================
        Changing svg color
        ...
        $(".scroller-wrapper").each(function () {
            if (
                $(this).width() - 26 <=
                $(this).find(".products_navs_list").width()
            ) {
        ...
        function footerSpace() {
            if ($(".proceed-cart-btn").length) {
                if (window.innerWidth < 576) {
                    $(".footer").css(
                        "padding-bottom",
                        $(".proceed-cart-btn").height() + 20
                    );
                } else {
